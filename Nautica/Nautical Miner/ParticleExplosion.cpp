...
//{
//	myIsActive = true;
//	myIntensityModulation = anIntensity / INTENSITY_MODULATION_DIVISER_EXPLOSION;
...
//			aPosition,
//			Util::DegToVec2(tempAngle) * (anIntensity + Util::RandFloat(-myIntensityModulation, myIntensityModulation)),
//			aColor,
