...
//	myIntensityModulation = myIntensity / INTENSITY_MODULATION_DIVISER_FOUNTAIN;
//	myGravity = gravity;
//	myIsActive = true;
...
//			myPosition,
//			Util::DegToVec2(tempAngle) * (myIntensity + Util::RandFloat(-myIntensityModulation, myIntensityModulation)),
